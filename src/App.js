  ...
  render() {
    ...
    if(this.state.selectedItems.length > 0) {
      selected = this.state.selectedItems.map(
          (item, index) => <option onClick={this.selecting} onDoubleClick={this.onDoubleClick} key={index} id={index} value={item.value}>{item.prettyName}</option>
      );
    }
    ...
    if(options.length > 0) {
      ...
      options = this.state.filteredCategories.map((field, index) =>
          <option onClick={this.selecting} onDoubleClick={this.onDoubleClick} key={index} id={index} value={field.value}>{field.prettyName}</option>
      );
    }
    ...
    return (
      <div className="App">
        <div className="sourceOptions">
          ...
          <select name="sourceOpts" id="sourceOpts" multiple>
            {options}
          </select>
        </div>
